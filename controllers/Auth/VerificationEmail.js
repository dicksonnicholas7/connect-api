...
module.exports.SendMailVerify = async (emailReceiver, token, hostname)=>{
    ...
    <p style="line-height: 1.2; word-break: break-word; mso-line-height-alt: 14px; margin: 0;"> </p>
    <p style="line-height: 1.2; word-break: break-word; font-size: 14px; mso-line-height-alt: 17px; margin: 0;margin-left: 15px;"><span style="font-size: 14px;">Confirmation Link : Please copy and paste the link below if the button is inactive </span></p>
